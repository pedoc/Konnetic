...
namespace Konnetic.Sip
{
    ...
    /// </remarks>
    [Serializable]
    public class SipFormatException : SipException
    {
        #region Constructors
    ...
    /// </remarks>
        ...
        public SipFormatException(string message)
            : base(message)
        {
        }
        ...
        public SipFormatException(string message, Exception innerException)
            : base(message, innerException)
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="SipFormatException"/> class with serialized data.
        /// </summary>
        ...
        /// </exception>
        protected SipFormatException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
