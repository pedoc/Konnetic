...
{
    /// <summary>The Route HeaderField is used to force routing for a request through the listed set of proxies. 
    /// </summary>
    /// <remarks> 
    ...
    public sealed class RouteHeaderField : AddressedHeaderFieldBase
    {
        #region Fields

        internal const string CompareName = "ROUTE";
        internal const string CompareShortName = CompareName;

        /// <summary>
        /// The long form of the name.
        /// </summary>
        internal const string LongName = "Route";
        ...
        public RouteHeaderField(string uri)
            : this(new SipUri(uri))
        {
        }
        ...
        public RouteHeaderField(SipUri uri)
            : base(uri)
        {
            Init();
        }
		...
		/// <summary>
		/// Performs an implicit conversion from <see cref="System.String"/> to <see cref="Konnetic.Sip.Headers.RouteHeaderField"/>.
		/// </summary>
		/// <param name="value">The string value representing the HeaderField.</param>
        /// <returns>A new <see cref="Konnetic.Sip.Headers.RouteHeaderField"/> populated from the <paramref name="value"/> parameter.</returns>
        /// <exception cref="ArgumentNullException">Thrown on null (<b>Nothing</b> in Visual Basic) <paramref name="value"/>.</exception>
        public static implicit operator RouteHeaderField(String value)
        {
            PropertyVerifier.ThrowOnNullArgument(value,"value");

            RouteHeaderField hf = new RouteHeaderField();
            hf.Parse(value);
            return hf;
        }

		/// <summary>
		/// Performs an explicit conversion from <see cref="Konnetic.Sip.Headers.RouteHeaderField"/> to <see cref="System.String"/>.
		/// </summary>
        ...
        public static explicit operator string(RouteHeaderField headerField)
        {
...
public override HeaderFieldBase Clone()
        {
            RouteHeaderField newObj = new RouteHeaderField(Uri);
...
/// <threadsafety static="true" instance="false" /> 
        ...
        public override bool Equals(object obj)
        {
            ...
            RouteHeaderField p1 = obj as RouteHeaderField;
            if((object)p1 == null)
                {
                HeaderFieldGroup<RouteHeaderField> p = obj as HeaderFieldGroup<RouteHeaderField>;
                if((object)p == null)
                    {
                    return false;
                    }
        ...
        private void Init()
        {
            //RecreateTag();
            AllowMultiple = true;
            FieldName = RouteHeaderField.LongName;
            CompactName = RouteHeaderField.LongName;
        }
